...
public class ItemController {
    ...
    @Operation(summary = "[관리자] 상품 추가", description = "상품을 추가합니다")
    ...
    @Operation(summary = "[관리자] 상품 수정", description = "상품을 수정합니다")
    @PreAuthorize("hasRole('ADMIN')")
    ...
    @Operation(summary = "[관리자] 상품 삭제", description = "상품을 삭제합니다")
    @PreAuthorize("hasRole('ADMIN')")
    ...
    @Operation(summary = "[관리자] 상품 이미지 추가", description = "상품 이미지를 추가합니다")
    @PreAuthorize("hasRole('ADMIN')")
    ...
    @Operation(summary = "[관리자] 상품 이미지 삭제", description = "상품 이미지를 삭제합니다")
    @PreAuthorize("hasRole('ADMIN')")
