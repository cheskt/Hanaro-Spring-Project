...
public enum ErrorStatus implements BaseErrorCode {
	...
	// 배치 관련 에러
	BATCH_ALREADY_RUNNING(HttpStatus.CONFLICT, "BATCH4000", "배치가 이미 실행 중입니다."),
	BATCH_INSTANCE_COMPLETE(HttpStatus.CONFLICT, "BATCH4001", "이미 완료된 배치 인스턴스입니다."),
	BATCH_INVALID_PARAM(HttpStatus.BAD_REQUEST, "BATCH4002", "배치 파라미터가 올바르지 않습니다."),
	BATCH_RESTART_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "BATCH5000", "배치 재시작에 실패했습니다."),
	BATCH_LAUNCH_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "BATCH5001", "배치 실행에 실패했습니다."),
